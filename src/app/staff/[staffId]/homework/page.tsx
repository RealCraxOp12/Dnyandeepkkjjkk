import { getAssignments } from "@/app/actions/homework";
import HomeworkClient from "@/app/homework/HomeworkClient";
import { prisma } from "@/lib/prisma";

export const dynamic = "force-dynamic";

export default async function StaffHomeworkPage({ params }: { params: Promise<{ staffId: string }> }) {
  ...
  return (
    <div className="flex-1 overflow-auto p-8 bg-slate-50 dark:bg-slate-950">
      <HomeworkClient initialAssignments={assignments} classes={classes} lockedSubject={lockedSubject} />
    </div>
  );
}
