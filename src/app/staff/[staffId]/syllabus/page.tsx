import { getSyllabus } from "@/app/actions/academicMaterials";
import SyllabusClient from "@/app/syllabus/SyllabusClient";
import { prisma } from "@/lib/prisma";

export const dynamic = "force-dynamic";

export default async function StaffSyllabusPage({ params }: { params: Promise<{ staffId: string }> }) {
  ...
  return (
    <div className="flex-1 overflow-auto p-8 bg-slate-50 dark:bg-slate-950">
      <SyllabusClient initialSyllabus={syllabus} classes={classes} lockedSubject={lockedSubject} />
    </div>
  );
}
